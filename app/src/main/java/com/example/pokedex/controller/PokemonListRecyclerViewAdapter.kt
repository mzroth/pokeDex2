...
class PokemonListRecyclerViewAdapter(private var list: List<NameUrl>, private val clickListener:
PokemonListRecyclerViewClickListener) : RecyclerView.Adapter<PokemonListRecyclerViewHolder>() {
